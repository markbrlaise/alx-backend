...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    """
    Takes 2 integers and returns a tuple of size two
    containing the start and end index corresponding to the range of
    indices to return in a list for those pagination parameters
    Args:
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Takes 2 integers and returns requested page from the dataset
        Args:
